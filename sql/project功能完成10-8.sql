...
--
-- Host: 127.0.0.1
-- Generation Time: 2022-10-08 14:10:41
...
(5, '第三次运动会', '2022-08-18', 1, 1, '第三次运动会活动简介', '活动详细信息', 0),
...
CREATE TABLE `details` (
  ...
  `add_inte` int(200) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `details` (`id`, `activ_id`, `deta_evaluation`, `deta_win`, `add_inte`) VALUES
(2, 1, '非常好', 1, 1),
(3, 1, '还不错', 0, 1),
(2, 2, '测试测试测试活动评价', 0, 1),
(2, 5, '', 0, 1),
...
--
DELIMITER $$
CREATE TRIGGER `details_add_inte` AFTER UPDATE ON `details` FOR EACH ROW UPDATE `personal` SET `integral`=`integral`+new.add_inte WHERE `id`=new.id
$$
DELIMITER ;
...
(2, '小王', '男', 9, '语文部', '2022-07-02', '2001-05-02'),
(3, '小米', '女', 7, '实习部', '2022-07-03', '2000-02-02'),
